...
abstract class Application extends Module {
    ...
    public function getRuntimePath() {
        if ($this->_runtimePath === null) {
            $this->setRuntimePath(substr($this->getBasePath(), 0,strrpos($this->getBasePath(),'t')+1) . DIRECTORY_SEPARATOR . 'logs' . DIRECTORY_SEPARATOR . 'runtime');
        }
       // echo $this->_runtimePath;exit;
