-- Rpc 协议系统
module("AlipayCBRpc", package.seeall)
...
function _Recv(args, body, bodyFile)
    ...
    local data = ApiPayMgr.AliPayQRNotify(content)
    --print("CAliPay.AliPayQRNotify: ", data, args, body, bodyFile, content)
    return data
end
