...
class Http
{
     ...
     * @return string
     */
    public static function getRequest($url, $data = [], $charset = 'UTF-8', $proxy = null, $expire = 30)
    {
        ...
        $this_header = array_merge($this_header,self::herder());
